...
public class BackRefListTabeditModel extends BackRefListModel implements Serializable {
	...
	public BackRefListTabeditModel(ViewController viewCtrl, Map<String, String> store, Entity entity, String entityName, String queryName,
	...
	/** Logger */
	private static final Logger LOGGER = Logger.getLogger(BackRefListTabeditModel.class);
	...
	private void copyMainEntityOnRow(Row row, RequestContext context) {
		...
		ListData rowData = new BusinessController().getBackRefListDataSingleElement(entity, entityName, linkName, queryName,
				currentEntity.getPrimaryKey(), context);
